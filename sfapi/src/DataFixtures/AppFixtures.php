...
class AppFixtures extends Fixture
{
    ...
    {
        $course = new Course();
        $course->setTitle('La malédiction du masque Gélédé :moai:')
            ->setDescription(
        ...
        $course2 = new Course();
        $course2->setTitle('La carte au trésor :world_map:')
            ->setDescription(
            ...
            [
                ...
                'story' => [
                    ...
                    [
                        'image' => "https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/icon/Zar" .
                            "afa_head.webp",
                        'text' => 'Visiteur, je te remercie ! Nous allons y mettre fin ensemble !',
                    ],
                    [
                        'image' => "https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/icon/Zar" .
                            "afa_head.webp",
