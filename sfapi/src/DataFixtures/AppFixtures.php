...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $course->setTitle('La malédiction du masque Gélédé')
            ->setDescription(
                "Marguerite a besoin de vous pour lever la malédiction du masque gélédé. Des monstres attirés par le masque viennent voler les œuvres du musée. Parcourir le musée à la recherche des objets permettant de lever la malédiction avant qu'il ne soit trop tard. Réunir un instrument, un poil d'animal et une statue.Une fois réunie, le rituel pour lever la malédiction peut se faire."
            )
        ...
        $roomsData = [
            [
                ...
                'image' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/room/room/2etage/r24.webp',
            ],
            [
                'id' => 2,
                'floor' => 1,
                'name' => 'Galerie de zoologie',
                'image' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/room/room/1etage/r9.webp',
            ],
            [
                'id' => 3,
                'floor' => 2,
                'name' => 'Salle des arts décoratifs extra-européens',
                'image' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/room/room/2etage/r23.webp',
            ],
        ];
        ...
        $stepsData = [
            [
                ...
                'story' => [
                    [
                        'image' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/zarafa_icon.webp',
                ...
                'activity' => [
                    'ref_image' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/plume_hibou_hulotte.webp',
                    'answers' => [
                        ['type' => 'IMAGE', 'src' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/heron_cendre.webp'],
                        ['type' => 'IMAGE', 'src' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/piaf1-1.webp'],
                        ['type' => 'IMAGE', 'src' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/chouette_hulotte.webp'],
                        ['type' => 'IMAGE', 'src' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/coracine_casquee.webp'],
                    ],
                    'hints' => [
                        ['image' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/icon/zarafa_icon.webp', 
            ...
            [
                ...
                'activity' => [
                    'answers' => [
                        ['type' => 'IMAGE', 'src' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/flute.webp'],
                        ['type' => 'IMAGE', 'src' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/instrument_inconnue.webp'],
                        ['type' => 'IMAGE', 'src' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/truc.webp'],
                        ['type' => 'IMAGE', 'src' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/20241218_165950.webp'],
                    ],
                    'hints' => [
                        ['image' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/icon/zarafa_icon.webp'],
                    ],
            ...
            [
                ...
                'activity' => [
                    'ref_image' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/icon/zarafa_icon.webp',
                    'answers' => [
                        ['type' => 'IMAGE', 'src' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/20241218_170626.webp'],
                        ['type' => 'IMAGE', 'src' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/animaux_jouet_2.webp'],
                        ['type' => 'IMAGE', 'src' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/massue_patu_wahaika.webp'],
                        ['type' => 'IMAGE', 'src' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/20241218_170318.webp'],
                    ],
                    'hints' => [
                        ['image' => 'https://dbgjqsyfbgqboyomqfjr.supabase.co/storage/v1/object/public/Musee/icon/zarafa_icon.webp', 
